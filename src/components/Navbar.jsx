...
const Navbar = () => {
  ...
  return (
    ...
    <Link href='/' className='underline decoration-[#403E3E] font-medium text-gray-900'>BookStore</Link>
    ...
    {!data && <> <Link href='/login' className='underline decoration-[#403E3E] font-medium text-gray-900'>Login</Link>
    <Link href='/signup' className='underline decoration-[#403E3E] font-medium text-gray-900'>Signup</Link> </>}
    </div>
  )
}
