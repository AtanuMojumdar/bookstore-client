...
const Google = () => {
  ...
  return (
    <div id='google' onClick={googleLogin} className='bg-white rounded-full cursor-pointer px-4 flex items-center justify-left w-[90%] mt-6 h-12'>
        ...
        <p className='font-medium text-base max-max-google:hidden max-min-google:block text-gray-600'>Sign in with Google</p>
        <p className='font-medium text-base hidden max-max-google:block max-min-google:hidden text-gray-600'>Sign in</p>
        </div>
    </div>
  )
}
