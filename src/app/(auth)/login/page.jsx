  ...
  return (
    <>
      <div className='grid md:grid-cols-2 grid-cols-1 gap-0 h-[100vh] px-2'>
        ...
        <h1 className='text-left text-[#282828] text-4xl font-bold mt-14'>Log In</h1>
        <p className='md:text-base text-sm'>New here? <span className='underline text-[#AA6B48]'><Link href='/signup'>Sign up</Link></span></p>
          </div>
          ...
          <div className='mt-14 pl-10'>
            ...
            <button onClick={login} className='text-white shadow-lg text-lg font-semibold rounded w-[80%] text-center bg-[#AA6B48] h-[3rem] md:h-[4rem]'>
              Sign In
            </button>
            </div>
